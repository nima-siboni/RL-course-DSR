...
class agent_learner:
    ...
    def __init__(self, nr_features, nr_actions, gamma=0.99, stddev=0.2, learning_rate=0.0001):
        ...
        x_Q = layers.Dense(64, activation='relu', kernel_initializer=initializer_Q, name='relu_dense_Q_1')(inputs_Q)
        ...
        x_Q_t = layers.Dense(64, activation='relu', kernel_initializer=initializer_Q_t, name='relu_dense_Qt_1')(inputs_Q_t)
